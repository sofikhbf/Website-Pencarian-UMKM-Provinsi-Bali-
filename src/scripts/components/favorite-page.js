  ...
  render() {
    ...
    <div class="bg-white py-6 sm:py-8 md:px-12 lg:py-12 px-4">
        <div class="container  items-center justify-between mx-auto">
          <h2 class="text-gray-800 text-2xl lg:text-3xl font-bold text-center mb-4">Produk Favorite</h2>
          <p class="max-w-screen-md text-gray-500 md:text-lg text-center mx-auto">Menampilkan produk favorite</p>
        </div>
